...
-- PRUEBA PARA EL TRIGGER DEL MÍNIMO DE OYENTES EN LOS ARTISTAS
UPDATE ARTISTAS SET OYENTES = -1 WHERE IDENTIFICADOR = '000001PE';

-- PRUEBA PARA EL TRIGGER DEL MÍNIMO DE REPRODUCCIONES EN LAS CANCIONES
...
-- PRUEBA PARA EL TRIGGER DEL MÍNIMO DE DURACIÓN EN LOS CONCIERTOS
